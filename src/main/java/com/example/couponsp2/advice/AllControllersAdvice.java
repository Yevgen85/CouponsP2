...
public class AllControllersAdvice {
    ...
    @ResponseBody
    @ExceptionHandler(value = {CompanyException.class, CouponException.class, CustomerException.class, AuthorizationException.class, MethodArgumentNotValidException.class})
